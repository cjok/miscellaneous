...
ifeq ("$(FEATURE_SWCHR_I_100MOHM)","yes")
    C_OPTION += -DFEATURE_SWCHR_I_100MOHM
endif

ifeq ("$(TINNO_PL_TRUN_ON_CHARGE_LED)","yes")
    C_OPTION += -DTINNO_PL_TRUN_ON_CHARGE_LED
endif

#liaoye@2016/10/25, fix bugid:DHACN-785
ifeq ("$(GET_OCV_FROM_PL)","yes")
    C_OPTION += -DGET_OCV_FROM_PL
endif

# TINNO BEGIN
# Added by liaoye on Nov. 22, 2016 for: add function--battery temperature check during bootup
ifeq ("$(FEATURE_CHECK_TEMPERATURE_BOOTUP)","yes")
    C_OPTION += -DFEATURE_CHECK_TEMPERATURE_BOOTUP
endif
# TINNO END
