...
$Header: //components/rel/boot.bf/3.1.2.c2/boot_images/core/boot/secboot3/src/boot_extern_pmic_interface.h#1 $
$DateTime: 2015/04/28 11:23:07 $
$Author: pwbldsvc $
...
**  Function :  boot_pm_sbl_batt_temp_check

** ==========================================================================
*/
/*! 
 * @brief This function executes check battery ntc temperature
 * @return Error flag.
 *
 */ 
// TINNO BEGIN
...
#ifdef FEATURE_BOOT_EXTERN_PMIC_COMPLETED
  pm_err_flag_type boot_pm_sbl_batt_temp_check(void);
#else
  static inline pm_err_flag_type boot_pm_sbl_batt_temp_check(void)
  {
    return PM_ERR_FLAG__SUCCESS;
  }
#endif
