...
/* ==========================================================================
  ...
  $Header: //components/rel/boot.bf/3.1.2.c2/boot_images/core/api/systemdrivers/pmic/pm_boot.h#1 $
...
/**
 * @name pm_sbl_batt_temp_check
 *
 * @brief This function executes check battery ntc 
 *   temperature
 * @param [in] void
 *
 * @return pm_err_flag_type
